...
public class GongyingshangController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		// 根据登录查询用户信息
        GongyingshangEntity u = gongyingshangService.selectOne(new EntityWrapper<GongyingshangEntity>().eq("gongyingshanghao", username));
        // 当用户不存在或验证密码不通过时
        ...
        // 获取登录token
		String token = tokenService.generateToken(u.getId(), username,"gongyingshang",  "供应商" );
        //返回token
    ...
    public R register(@RequestBody GongyingshangEntity gongyingshang){
    	...
    	GongyingshangEntity u = gongyingshangService.selectOne(new EntityWrapper<GongyingshangEntity>().eq("gongyingshanghao", gongyingshang.getGongyingshanghao()));
		if(u!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        GongyingshangEntity u = gongyingshangService.selectById(id);
    ...
    public R resetPass(String username, HttpServletRequest request){
        ...
        //重置密码为123456
        u.setMima("123456");
        gongyingshangService.updateById(u);
    ...
    public R update(@RequestBody GongyingshangEntity gongyingshang, HttpServletRequest request){
        ...
        if(null!=gongyingshang.getGongyingshanghao())
        {
            // 修改token
            TokenEntity tokenEntity = new TokenEntity();
            tokenEntity.setUsername(gongyingshang.getGongyingshanghao());
            tokenService.update(tokenEntity, new EntityWrapper<TokenEntity>().eq("userid", gongyingshang.getId()));
        }
        return R.ok();
    }
